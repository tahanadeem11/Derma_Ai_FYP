...
import 'package:heal_wiz_application/Screens/Dependencies/AnimatedToggle.dart';
import '../../themes/theme.dart';
import '../themes/toggle_button.dart';
...
// Replace with the actual import for your HomePage
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  bool _isPasswordVisible = false; // Track whether the password is currently visible

  @override
  TextEditingController firstName = TextEditingController();
  TextEditingController listName = TextEditingController();
  TextEditingController emailCsignup = TextEditingController();
  TextEditingController passwordCsignup = TextEditingController();
//  final FirebaseAuth _auth = FirebaseAuth.instance;
  int _toggleValue = 0;
                        ...
                        child: Column(
                          children: [
                            ...
                            AnimatedToggle(
                              ...
                              buttonColor: const Color(0xFF43A1D4),
                                  ...
                                  children: [
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        focusedBorder: UnderlineInputBorder(  // Add a single line below the field when focused
                                ...
                                Column(
                                  children: [
                                    TextFormField(
                                      ...
                                      obscureText: !_isPasswordVisible, // Hide or show the password characters based on _isPasswordVisible
                                      decoration: InputDecoration(
                                        ...
                                        suffixIcon: GestureDetector( // Add a gesture detector for the suffix icon
                                          onTap: () {
                                            setState(() {
                                              _isPasswordVisible = !_isPasswordVisible; // Toggle the visibility of the password
                                            });
                                          },
                                          child: Icon( // Show an eye icon when password is hidden, and a crossed eye icon when password is visible
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        print("${emailCsignup.text}");
                                        registerUser(
                                          emailCsignup.text,
                                          passwordCsignup.text,
                                          firstName.text,
                                          listName.text,
                                        );
                                      },
