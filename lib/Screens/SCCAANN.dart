...
class ResponseDatasd extends StatefulWidget {
  ResponseDatasd({Key? key,}) : super(key: key);

  @override
  State<ResponseDatasd> createState() => _ResponseDatasdState();
}

class _ResponseDatasdState extends State<ResponseDatasd> {
          ...
          onSelected: (value) {
            ...
            switch (value) {
              ...
              case "newScan":
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ResponseDatasd()),
                );
                break;
              case "yourScan":
