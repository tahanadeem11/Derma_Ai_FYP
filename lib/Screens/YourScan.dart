...
import 'login.dart';
class YourScan extends StatefulWidget {
  YourScan({Key? key,}) : super(key: key);

  @override
  State<YourScan> createState() => _YourScanState();
}

class _YourScanState extends State<YourScan> {
          ...
          onSelected: (value) {
            ...
            switch (value) {
              ...
              case "rashes":
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => YourScan()),
                );
                break;
              case "appointment":
                Navigator.push(
